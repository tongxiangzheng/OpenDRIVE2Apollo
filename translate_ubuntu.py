...
def toComOpT(path):
  translate(path,"01")
  cp("01.bin","/home/txz/ComOpT/scripts/comopt/data/map/openDriveTest/base_map.bin")
  cp("01.bin","/home/txz/ComOpT/scripts/comopt/data/map/openDriveTest/svl_map.bin")
